...
### Модуль rolling.php
```
Данный модуль выбирает только одного пользователя и присваевает ему $text.
```
...
<a name="sanya"></a>
## Александр
![картинка](https://github.com/fplve/vika/raw/gh-pages/assets/images/Sasha.jpg)
```
Программист, идеолог.
```
-------------------------
...
<a name="ylya"></a>
## Юлия
![картинка](https://github.com/fplve/vika/raw/gh-pages/assets/images/Ylya.jpg)
```
Технический редактор, программист.
```
-------------------------

<a name="yar"></a>
## Ярослава
![картинка](https://github.com/fplve/vika/raw/gh-pages/assets/images/Yarik.jpg)
```
Таймкиппер, программист.
```
-------------------------

<a name="vlad"></a>
## Владислав
![картинка](https://github.com/fplve/vika/raw/gh-pages/assets/images/Vlad.jpg)
```
...
<a name="leh"></a>
## Алексей
![картинка](https://github.com/fplve/vika/raw/gh-pages/assets/images/Lesha.jpg)
```
Пиар-менеджер, программист.
```
-------------------------